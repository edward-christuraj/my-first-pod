...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Edward Sagayaraj/MyCocoapodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Edward Sagayaraj' => 'edward.christuraj@comvivia.com' }
  s.source           = { :git => 'https://github.com/Edward Sagayaraj/MyCocoapodsLibrary.git', :tag => s.version.to_s }
